...
function LauncherIcon({
  ...
  return (
    <button
      onClick={onClick}
      className="group flex flex-col items-center justify-start rounded-[28px] border border-white/10 bg-white/[0.06] p-4 text-center shadow-[0_10px_30px_-12px_rgba(0,0,0,0.55)] backdrop-blur-xl transition-all duration-300 hover:scale-[1.03] hover:bg-white/[0.1]"
    >
...
export function ScriptoraMobileLauncher({
  ...
  return (
    <div className="relative overflow-hidden rounded-[34px] border border-white/10 bg-[#0b1020] p-4 text-white shadow-[0_30px_80px_-25px_rgba(0,0,0,0.75)]">
      ...
      <div className="relative z-10">
        ...
        <div className="mb-5 grid grid-cols-2 gap-3">
          ...
          <button
            ...
            className="flex items-center justify-between rounded-[22px] border border-white/10 bg-white/[0.07] px-4 py-4 text-left"
          >
            <div>
