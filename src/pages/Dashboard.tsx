    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-6 pt-10 pb-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-0.5">
                <p className="text-sm font-bold text-foreground">Nuovo Libro</p>
              ...
              <p className="text-xs text-muted-foreground">Dalla tua idea a un manoscritto completo con il motore Scriptora.</p>
            </div>
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="min-w-0 flex-1">
                <p className="text-[10px] text-primary uppercase tracking-[0.22em] mb-1.5 flex items-center gap-1.5 font-semibold">
                  <Clock className="h-3.5 w-3.5" /> CONTINUA PROGETTO
                </p>
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-[0.22em]">Scriptora Apps</span>
          <div className="h-px flex-1 bg-border/50" />
        </div>

        {/* Secondary Actions — pro grid */}
        <div className="grid grid-cols-3 sm:grid-cols-4 gap-3 mb-8 max-w-2xl mx-auto">
          {cards.map(card => {
            const inner = (
              <button
                key={card.title}
                onClick={card.action}
                className="relative aspect-square w-full rounded-[28px] border border-border/50 bg-gradient-to-b from-card to-card/85 hover:border-primary/30 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-primary/10 transition-all duration-200 group overflow-hidden"
              >
                ...
                <div className="flex h-full flex-col items-center justify-center gap-3 px-2 text-center">
                  <div className={`h-14 w-14 rounded-[20px] border border-border/60 bg-muted/50 group-hover:bg-muted/80 transition-colors flex items-center justify-center shadow-sm ${card.color}`}>
                    <card.icon className="h-6 w-6" />
                  </div>
                  <div className="min-w-0">
                    <p className="text-[11px] sm:text-xs font-semibold text-foreground leading-tight line-clamp-2">
                      {card.title}
                    </p>
                  </div>
                </div>
